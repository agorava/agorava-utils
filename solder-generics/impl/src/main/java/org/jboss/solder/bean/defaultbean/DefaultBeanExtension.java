...
import static org.jboss.solder.util.collections.Multimaps.newSetMultimap;
    ...
    void afterBeanDiscovery(@Observes AfterBeanDiscovery event, BeanManager manager) {
        ...
        for (Synthetic qual : allDefaultBeanQualifiers) {
            ...
            if (defaultManagedBeans.containsKey(qual)) {
                ...
                log.fine("Installing default managed bean " + db);
                event.addBean(db);
                ...
                log.fine("Installing default producer bean " + db);
                event.addBean(db);
